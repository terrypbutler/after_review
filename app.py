...
from modules.report_renderers import (
    ...
    render_photo_grid,
    render_student_card,
    render_working_group_finder,import streamlit as st
import pandas as pd
import altair as alt
...
attainment_factor = current_attainment_factor(st.session_state)

cohort_data = {}
load_errors = {}
for cohort_name, cohort_url in COHORT_URLS.items():
    try:
        cohort_data[cohort_name] = apply_attainment_factor(
            apply_score_factors(
